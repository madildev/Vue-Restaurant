            ...
            <div class="col-md-5">
              <div class="hero-content">
                ...
                <div class="hero-btn mt-5">
                    <button class="btn custom-btn btn-info btn-md mr-4">Explore</button>
                    <button class="btn custom-btn btn-outline-secondary btn-md">Products</button>
                </div>
              </div>
            </div>
            <div class="col-md-7">
                <div class="graphic">
                    <img src="../assets/undraw_special_event_4aj8.svg" alt="">
                </div>
            </div>
          </div>
        </div>
